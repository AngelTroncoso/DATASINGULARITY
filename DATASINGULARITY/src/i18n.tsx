...
export const TRANSLATIONS = {
  es: {
    header: {
      ...
      import: 'Importar',
      language: 'Idioma',
      datahubOnline: 'DATAHUB EN LÍNEA',
      datahubOffline: 'DATAHUB OFFLINE',
    },
    agentDeck: {
    ...
    modal: {
      title: 'Importar Metadatos Personalizados de DataHub',
      subtitle: 'Pegue objetos de metadatos JSON / GraphQL de DataHub para modelar su propio ecosistema.',
...
Los 7 agentes científicos (Physics, Chemistry, Entropy, Genome, Chronos, Guardian y Oracle) han modelado el ecosistema de datos actual. Seleccione un escenario de simulación o formule una consulta científica sobre la infraestructura.`,
  ...
  en: {
    ...
    modal: {
      title: 'Import Custom DataHub Metadata',
      subtitle: 'Paste custom DataHub JSON / GraphQL metadata objects to model your own ecosystem.',
      ...
      jsonLabel: 'DataHub JSON Input:',
      loadSample: 'Load Sample Template',
      cancel: 'Cancel',
      parseAnalyze: 'Parse & Analyze',
      parseAndAnalyze: 'Parse & Analyze',
    },
...
The 7 scientific agents (Physics, Chemistry, Entropy, Genome, Chronos, Guardian, and Oracle) have modeled the current data ecosystem. Select a simulation scenario or ask a scientific query about the infrastructure.`,
  ...
  zh: {
    header: {
      ...
      import: '导入',
      language: '语言',
      datahubOnline: 'DATAHUB 在线',
      datahubOffline: 'DATAHUB 离线',
    },
    agentDeck: {
    ...
    modal: {
      title: '导入自定义 DataHub 元数据',
      subtitle: '粘贴自定义 DataHub JSON / GraphQL 元数据对象来建立您自己的生态系统模型。',
      ...
      jsonLabel: 'DataHub JSON 输入:',
      loadSample: '加载示例模板',
      cancel: '取消',
      parseAnalyze: '解析与分析',
      parseAndAnalyze: '解析与分析',
    },
